...
<body>
    <div class="container">
        <div class="content">
            ...
            <h5>Click images for external information:</h5>
            <div class="image-container">
                <div class="image-item">
                    ...
                    <p class="image-caption">Newest work</p>
                </div>
                <div class="image-item">
                    ...
                    <p class="image-caption">Experimenting with Illustrator</p>
                </div>
                <div class="image-item">
                    ...
                    <p class="image-caption">First work on Illustrator</p>
                </div>
            </div>
        ...
        <div class="sidebar">
            <h3>About Me</h3>
            <p>I'm an illustrator passionate about capturing the beauty of Malta's architecture. Using Adobe Illustrator, I blend traditional and modern techniques to create unique artworks.</p>
